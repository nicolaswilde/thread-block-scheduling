...
int main() {
    int blocks[20] = {N_SM * 2,
                      N_SM * 2 + 4, N_SM * 2 + 5, N_SM * 2 + 6, N_SM * 2 + 7, N_SM * 2 + 8,
                      N_SM * 3 - 2, N_SM * 3 - 1, N_SM * 3 + 0, N_SM * 3 + 1, N_SM * 3 + 2,
                      N_SM * 4 - 2, N_SM * 4 - 1, N_SM * 4 + 0, N_SM * 4 + 1, N_SM * 4 + 2,
                      N_SM * 5 + 0, N_SM * 6 + 0, N_SM * 7 + 0, N_SM * 8 + 0};
    for (int i = 0; i < 20; i++) {
        test(blocks[i]);
    }
}
